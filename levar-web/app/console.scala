...
package object console {
  ...
  /**
    ...
    */
  def createOrg(name: String, users: Seq[String]) {
    db.impl.addOrg(name, users)
  }
  ...
  /**
    ...
    * @param user the user name
    */
  def listOrgs(user: String) {
    for (org <- db.impl.listUserOrgs(user)) println(s"- $org")
  }
}
